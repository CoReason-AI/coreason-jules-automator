...
def test_settings_defaults(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.delenv("COREASON_MAX_RETRIES", raising=False)
...
def test_missing_secrets(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.delenv("COREASON_GITHUB_TOKEN", raising=False)
    monkeypatch.delenv("COREASON_GOOGLE_API_KEY", raising=False)
...
def test_empty_secrets(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setenv("COREASON_GITHUB_TOKEN", "")
    monkeypatch.setenv("COREASON_GOOGLE_API_KEY", "")
